...
const LEARNING_STATE_STORAGE_KEY = 'mds_gms2a_learning_state';
const LOGIN_STORAGE_KEY = 'mds_gms2a_student_login';
const PROGRESS_STORAGE_KEY = 'mds_gms2a_student_progress';
